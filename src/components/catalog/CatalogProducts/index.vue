      ...
      <div v-for="product in products" :key="`${product.name + product.id}`" class="product">
        ...
        <div class="product-center">
          ...
          <span class="product-center__text"
            >Цена:
            <span class="product-center__text product-center__mark">от ₽{{ product.min_price.price }}/шт.</span></span
          >
          <span class="product-center__text"
            >Мин. заказ: <span class="product-center__text product-center__mark">1000 шт.</span></span
          >
          <span class="product-center__description">{{ product.description }}</span>
        </div>
